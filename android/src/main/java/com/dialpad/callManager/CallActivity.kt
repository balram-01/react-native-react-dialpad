...
import com.dialpad.CallMonitorService

import com.dialpad.helpers.isOreoMr1Plus
import com.dialpad.helpers.isOreoPlus
...
class CallActivity : AppCompatActivity() {
  ...
  private var screenOnWakeLock: PowerManager.WakeLock? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      if (currentCall != null) {
        callViewModel = ViewModelProvider(this, CallViewModelFactory(CallRepository,
          audioManager))[CallViewModel::class.java]
      } else {
        finish()
        return
      }
  ...
  private fun addLockScreenFlags() {
    ...
    try {
      ...
      screenOnWakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK or PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.dialpad:full_wake_lock")
