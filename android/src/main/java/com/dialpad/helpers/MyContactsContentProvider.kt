...
import com.dialpad.models.SimpleContact


class MyContactsContentProvider {
  companion object {
    private const val AUTHORITY = "com.dialpad.helpers"
    ...
    fun loadAllContacts(context: Context):ArrayList<SimpleContact>{
      ...
      return getSimpleContacts(context,cursor)
    }
