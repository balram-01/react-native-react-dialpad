...
import com.dialpad.models.Contact
...
import com.dialpad.extensions.getByteArray
import com.dialpad.extensions.getIntValue
import com.dialpad.extensions.getLongValue
import com.dialpad.extensions.getPhotoThumbnailSize
import com.dialpad.extensions.getStringValue
import com.dialpad.extensions.queryCursor
import com.dialpad.extensions.showErrorToast
import com.dialpad.extensions.toast
import com.dialpad.models.Address
import com.dialpad.models.Email
import com.dialpad.models.Event
import com.dialpad.models.Group
import com.dialpad.models.IM
import com.dialpad.models.Organization
import com.dialpad.models.PhoneNumber

class ContactHelper(val context: Context) {
  private val BATCH_SIZE = 50

fun readableMapToContact(map: ReadableMap?): Contact {
    // Return a default Contact if map is null
    if (map == null) {
        return Contact(
            id = 0,
            prefix = "",
    ...
    val contactId = map.getInt("contactId") ?: 0
        ...
        if (arr != null) {
            for (i in 0 until arr.size()) {
                ...
                if (phoneMap != null) {
                    ...
                    val type = phoneMap.getInt("type") ?: 0
        ...
        if (arr != null) {
            for (i in 0 until arr.size()) {
                ...
                if (emailMap != null) {
                    ...
                    val type = emailMap.getInt("type") ?: 0
        ...
        if (arr != null) {
            for (i in 0 until arr.size()) {
                ...
                if (addressMap != null) {
                    ...
                    val type = addressMap.getInt("type") ?: 0
        ...
        if (arr != null) {
            for (i in 0 until arr.size()) {
                ...
                if (eventMap != null) {
                    ...
                    val type = eventMap.getInt("type") ?: 0
    ...
    if (map.hasKey("groups") && map.getType("groups")?.name == "Array") {
        ...
        if (arr != null) {
            for (i in 0 until arr.size()) {
                ...
                if (groupMap != null) {
                    val groupId = groupMap.getInt("id") ?: 0
